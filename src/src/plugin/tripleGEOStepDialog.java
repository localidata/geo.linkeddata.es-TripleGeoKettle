...
public class tripleGEOStepDialog extends BaseStepDialog implements StepDialogInterface {
	...
	public String open() {
		...
		this.shell.setText(Messages.getString( "tripleGEOStepDialog.Shell.Title"));
		...
		this.wMainTab.setText(Messages.getString( "tripleGEOStepDialog.Tab.MainTab"));
		...
		this.wlAttributeName.setText(Messages.getString("tripleGEOStepDialog.AttributeName.Label"));
		...
		this.wlFeature.setText(Messages.getString("tripleGEOStepDialog.Feature.Label"));
		...
		this.wlOntologyNS.setText(Messages.getString("tripleGEOStepDialog.OntologyNS.Label"));
		...
		this.wlOntologyNSPrefix.setText(Messages.getString("tripleGEOStepDialog.OntologyNSPrefix.Label"));
		...
		this.wlResourceNS.setText(Messages.getString("tripleGEOStepDialog.ResourceNS.Label"));
		...
		this.wlResourceNSPrefix.setText(Messages.getString("tripleGEOStepDialog.ResourceNSPrefix.Label"));
		...
		this.wlLanguage.setText(Messages.getString("tripleGEOStepDialog.Language.Label"));
		...
		this.wbbPathCSV.setText(Messages.getString("tripleGEOStepDialog.PathCSVButton.Label"));
		this.wbbPathCSV.setToolTipText(Messages.getString("tripleGEOStepDialog.PathCSVButtonTooltip.Label"));
		...
		this.wlPathCSV.setText(Messages.getString("tripleGEOStepDialog.PathCSV.Label"));
		...
		this.wluuids.setText(Messages.getString("tripleGEOStepDialog.uuids.Label"));
		...
		ciFields[0] = new ColumnInfo(Messages.getString("tripleGEOStepDialog.otherPrefix.Label"), 
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		ciFields[1] = new ColumnInfo(Messages.getString("tripleGEOStepDialog.other.Label"), 
				ColumnInfo.COLUMN_TYPE_TEXT, false);		
		...
		this.wlColumns.setText(Messages.getString("tripleGEOStepDialog.Columns.Label"));
		...
		ciColumns[0] = new ColumnInfo(Messages.getString("tripleGEOStepDialog.ShowColumns.Label"), 
				2, this.input.getShow(), true);
		ciColumns[1] = new ColumnInfo(Messages.getString("tripleGEOStepDialog.Column.Label"), 
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		ciColumns[2] = new ColumnInfo(Messages.getString("tripleGEOStepDialog.otherPrefixColumns.Label"), 
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		ciColumns[3] = new ColumnInfo(Messages.getString("tripleGEOStepDialog.otherColumns.Label"), 
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		...
		this.wRestartFields.setText(Messages.getString("tripleGEOStepDialog.RestartFields.Button"));
